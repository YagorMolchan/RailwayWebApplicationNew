...
namespace RailwayNew1.Controllers
{
    public class RoutesController : Controller
    {
        ...
        private readonly RoutRepository _repository;
        ...
        //GET: Routes
        public async Task<IActionResult> Index(Models.ViewModel.Search.IndexViewModel model)
        {
            List<Models.ViewModel.Route.IndexViewModel> listRoutes = await _repository.GetRoutesForSchedule(model);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Start,Finish,Country,Category")] Route route)
        {
            if (id != route.Id)
            {
                return NotFound();
